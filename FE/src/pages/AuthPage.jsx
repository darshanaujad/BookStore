...
export default function AuthPage() {
    ...
    return (
        <div className='min-h-screen flex flex-col lg:flex-row justify-center items-center'>
            {/* LEFT SIDE */}
            <div className='w-full lg:w-1/2 bg-[#fefefe] h-64 lg:h-screen order-1 lg:order-1'>
                <div className="w-full h-full flex justify-center items-center">
                    <img src="/BookMountain.png" alt="BookMountain" className='object-center w-full h-full object-cover' />
                </div>
            </div>

            {/* RIGHT SIDE */}
            <div className='w-full lg:w-1/2 bg-[#60b8e8] min-h-screen lg:h-screen flex justify-center items-center flex-col gap-3 px-4 py-8 lg:py-0 order-2 lg:order-2'>
                <div className="w-full sm:w-[80%] md:w-[70%] lg:w-[58%] h-10 bg-gray-300 rounded-[7px] flex justify-between items-center text-base sm:text-[18px] font-semibold overflow-hidden">
                    <button
                        ...
                        onClick={() => {setActiveTab('login')
                            // console.log('activetab value is : login');
                        }}
                    >
                        Login
                    </button>
                    <button
                        ...
                        onClick={() => {setActiveTab('register')
                            // console.log('activeTab value is : register');
                        }}
                    >
                        Register
                    </button>
                </div>
                <div className="flex flex-col items-center w-full sm:w-[85%] md:w-[75%] lg:w-[62%] max-w-md bg-white py-6 sm:py-8 px-6 sm:px-10 rounded-2xl shadow-lg">
                    {/* Welcome Text */}
                    ...
                    <div className="w-full flex gap-3 sm:gap-4 mb-4 sm:mb-6">
